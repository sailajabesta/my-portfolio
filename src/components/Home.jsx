...
const Home = () => {
  ...
  useEffect(() => {
    ...
    if (element) {
      init(element, {
        showCursor: true,
        strings: ["Sailaja Besta", "React Developer", "Frontend Developer"],
      });
    }
  }, []);

  return (
    <div className=" relative gap-5 md:gap-0 flex flex-col md:flex-row justify-center items-center h-screen mx-auto p-4 bg-gradient-to-r from-cyan-500 to-blue-500">
